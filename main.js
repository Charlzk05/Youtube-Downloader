...
mp4CheckBox.addEventListener("click", () => {
    mainForm.setAttribute("action", "youtube-downloader-server.charlzk.repl.co/download_mp4");
    mp3CheckBox.checked = false;
});

mp3CheckBox.addEventListener("click", () => {
    mainForm.setAttribute("action", "youtube-downloader-server.charlzk.repl.co/download_mp3");
